...
// Ensure Cloudflare Pages _redirects file for SPA Routing is written
try {
  writeFileSync(join(DEST, '_redirects'), '/* /index.html 200\n')
  console.log('[finalize] ✓ generated Cloudflare Pages _redirects file successfully')
} catch (e) {
  console.log('[finalize] skipped _redirects generation (pre-injected or read-only file exists):', e.message)
}
