...
const SEGMENTS = [
  { label: '5 نقاط', points: 5, color: '#D4AF37', textColor: '#1A2A6C' },
  { label: '10 نقاط', points: 10, color: '#1A2A6C', textColor: '#D4AF37' },
  { label: '15 نقطة', points: 15, color: '#B8860B', textColor: '#FFFFFF' },
  { label: '20 نقطة', points: 20, color: '#D4AF37', textColor: '#1A2A6C' },
  { label: '25 نقطة', points: 25, color: '#25398a', textColor: '#D4AF37' },
  { label: '30 نقطة', points: 30, color: '#B8860B', textColor: '#FFFFFF' },
  { label: '50 نقطة', points: 50, color: '#D4AF37', textColor: '#1A2A6C' },
  { label: '100 نقطة', points: 100, color: '#1A2A6C', textColor: '#D4AF37' },
]
